...
public class Interpreter {
    ...
    public static void main(String[] args) {
        ...
        MyIStack<IStmt> stck9 = new MyStack<IStmt>();
        stck9.push(ex9);

        try {
            Controller.typecheck(ex9);
        }
        catch (MyException e)
        {
        ...
        PrgState p9 = new PrgState(stck9);
        Repository repo9 = new Repository(p9, path);
        ...
        MyIStack<IStmt> stck10 = new MyStack<IStmt>();
        stck10.push(ex10);

        PrgState p10 = new PrgState(stck10);
        Repository repo10 = new Repository(p10, path);
