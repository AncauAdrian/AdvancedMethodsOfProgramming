...
public class PrgState {
    ...
    private MyIDictionary<Integer, Pair<Integer, List<Integer>>> semaphoreTable;
    ...
    public PrgState(MyIStack<IStmt> stack) {
        ...
        this.semaphoreTable = new MyDict<Integer, Pair<Integer, List<Integer>>>();
        this.id = nextid;
        PrgState.nextid++;
    }
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String, Value> symTable, MyIList<Value> out,
                    ...
                    MyIDictionary<Integer, Pair<Integer, List<Integer>>> sem) {
        this.exeStack = stack;
    ...
    public MyIDictionary<Integer, Pair<Integer, List<Integer>>> getSemaphoreTable() {
    ...
    public String formatLog()
    {
        ...
        String _sem = this.semaphoreTable.toString();
    ...
    public static List<IStmt> createExamples()
    {
        ...
        IStmt ex6 = concatStatements(new VarDeclStmt("a", new IntType()),
        ...
        IStmt ex7 = concatStatements(new VarDeclStmt("v1", new RefType(new IntType())),
                ...
                new ForkStmt(concatStatements(
                        new Acquire("cnt"),
                        new WriteHeapStmt("v1", new ArithExp(3, new ValueExp(new IntValue(10)), new ReadHeapExp(new VarExp("v1")))),
                        new PrintStmt(new ReadHeapExp(new VarExp("v1"))),
                        new Release("cnt"))),
                new ForkStmt(concatStatements(
                        new Acquire("cnt"),
                        new WriteHeapStmt("v1", new ArithExp(3, new ValueExp(new IntValue(10)), new ReadHeapExp(new VarExp("v1")))),
                        new WriteHeapStmt("v1", new ArithExp(3, new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(2)))),
                        new PrintStmt(new ReadHeapExp(new VarExp("v1"))),
                        new Release("cnt")
                        )),
                new Acquire("cnt"),
                new PrintStmt(new ArithExp(2, new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(1)))),
                new Release("cnt"));
